            ...
            <tbody>
                <?php foreach ($tanggapan as $tanggapan) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link(__('View'), ['action' => 'view', $tanggapan->id_tanggapan], ['class' => 'btn btn-xs btn-outline-primary', 'escape' => false]) ?>
                            <?= $this->Html->link(__('Edit'), ['action' => 'edit', $tanggapan->id_tanggapan], ['class' => 'btn btn-xs btn-outline-primary', 'escape' => false]) ?>
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $tanggapan->id_tanggapan], ['class' => 'btn btn-xs btn-outline-danger', 'escape' => false, 'confirm' => __('Are you sure you want to delete # {0}?', $tanggapan->id_tanggapan)]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
